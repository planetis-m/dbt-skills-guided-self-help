...
- [references/clinical-basis.md](references/clinical-basis.md): DBT structure,
  skills, evidence boundaries, and source links.
- [references/safety-and-scope.md](references/safety-and-scope.md): routing,
  conservative AI adaptation, escalation, and source links.
